...
async function connectAll() {
  ...
  try {
    ...
    localStorage.setItem('prod_archi_url_perf', urlP);
    localStorage.setItem('prod_archi_url_smm',  urlS);
    localStorage.setItem('archi_url_prod', urlPr);
    localStorage.setItem('prod_archi_url_cent', urlC);
    localStorage.setItem('prod_archi_tab_perf', tabP);
    localStorage.setItem('prod_archi_tab_smm',  tabS);
    localStorage.setItem('archi_tab_prod', tabPr);
    localStorage.setItem('prod_archi_tab_cent', tabC);
...
/* &#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552; INIT &#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552; */
(async function(){
  const uP  = localStorage.getItem('prod_archi_url_perf') || '';
  const uS  = localStorage.getItem('prod_archi_url_smm')  || '';
  const uPr = localStorage.getItem('archi_url_prod') || '';
  const uC  = localStorage.getItem('prod_archi_url_cent') || '';
  const tP  = localStorage.getItem('prod_archi_tab_perf') || 'performance';
  const tS  = localStorage.getItem('prod_archi_tab_smm')  || 'smm';
  const tPr = localStorage.getItem('archi_tab_prod') || 'prod';
  const tC  = localStorage.getItem('prod_archi_tab_cent') || 'centres';
  if(uP || uS || uPr || uC){
