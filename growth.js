...
async function connectAll() {
  ...
  try {
    ...
    localStorage.setItem('growth_url_perf', urlP);
    localStorage.setItem('growth_url_smm',  urlS);
    localStorage.setItem('growth_url_prod', urlPr);
    localStorage.setItem('growth_url_cent', urlC);
    localStorage.setItem('growth_tab_perf', tabP);
    localStorage.setItem('growth_tab_smm',  tabS);
    localStorage.setItem('growth_tab_prod', tabPr);
    localStorage.setItem('growth_tab_cent', tabC);
...
/* &#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552; INIT &#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552;&#9552; */
(async function(){
  const uP  = localStorage.getItem('growth_url_perf') || '';
  const uS  = localStorage.getItem('growth_url_smm')  || '';
  const uPr = localStorage.getItem('growth_url_prod') || '';
  const uC  = localStorage.getItem('growth_url_cent') || '';
  const tP  = localStorage.getItem('growth_tab_perf') || 'performance';
  const tS  = localStorage.getItem('growth_tab_smm')  || 'smm';
  const tPr = localStorage.getItem('growth_tab_prod') || 'prod';
  const tC  = localStorage.getItem('growth_tab_cent') || 'centres';
  if(uP || uS || uPr || uC){
